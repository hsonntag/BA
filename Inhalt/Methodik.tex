...
\begin{figure}
\begin{center}
\includegraphics[width=15cm]{BA-img/BA-img98.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.77cm,height=6.77cm]{graphics/fetus+vernix.png}
\includegraphics[width=6.77cm,height=6.77cm]{graphics/kopf+vernix.png}
\end{center}
