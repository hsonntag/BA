...
fMEG befinden sich die Quellen im Gehirn des Fötus und dafür ist Segmentierung des Kopfes als Begrenzung eine gute Näherung in Anbetracht der Qualität von 3D-US-Bildern. Die kugelähnliche Form des Kopfes ermöglicht es quasisphärische Korrekturen bei der Lösung des inversen Problems sinnvoll einzusetzen, dabei werden
...
radialen Dipolen ist \cite{Haueisen1997}. Nach [?CURRY REFERENCE MANUAL] verbessert diese Korrektur die Berechnungen für annähernd sphärische Volumenleiter. Dise Verbesserung sollte in weiteren Arbeiten für Volumenleitermodelle des Fötus noch quantifiziert werden. Ein weiterer Vorteil der näherungsweise sphärischen Geometrie des Kopfes ist die Möglichkeit der Suche der Kopfposition im Abdomen ausgehend vom fMEG, wie es in \cite{eltit} mit einer Kugelschicht als Kopfmodell gezeigt wurde.
